...
//UART4
    ...
    { UART4 , GPIOB, GPIO_PIN_8 , GPIO_AF8_UART4 },
    { UART4 , GPIOC, GPIO_PIN_11, GPIO_AF8_UART4 },
    { UART4 , GPIOD, GPIO_PIN_0 , GPIO_AF8_UART4 },
//UART5
    { UART5 , GPIOB, GPIO_PIN_5,  GPIO_AF14_UART5},
    { UART5 , GPIOB, GPIO_PIN_12, GPIO_AF14_UART5},
    { UART5 , GPIOD, GPIO_PIN_2,  GPIO_AF8_UART5 },
//UART7
    { UART7 , GPIOA, GPIO_PIN_8,  GPIO_AF11_UART7},
    { UART7 , GPIOB, GPIO_PIN_3,  GPIO_AF11_UART7},
    { UART7 , GPIOE, GPIO_PIN_7,  GPIO_AF7_UART7 },
    { UART7 , GPIOF, GPIO_PIN_6,  GPIO_AF7_UART7 },
//UART8
...
//USART6
    { USART6, GPIOC, GPIO_PIN_7,  GPIO_AF7_USART6},
    { USART6, GPIOG, GPIO_PIN_9,  GPIO_AF7_USART6},
}; 
...
//UART4
    ...
    { UART4 , GPIOB, GPIO_PIN_9,  GPIO_AF8_UART4 },
    { UART4 , GPIOC, GPIO_PIN_10, GPIO_AF8_UART4 },
    { UART4 , GPIOD, GPIO_PIN_1,  GPIO_AF8_UART4 },
//UART5
    { UART5 , GPIOB, GPIO_PIN_6,  GPIO_AF14_UART5},
    { UART5 , GPIOB, GPIO_PIN_13, GPIO_AF14_UART5},
    { UART5 , GPIOC, GPIO_PIN_12, GPIO_AF8_UART5 },
//UART7
    { UART7 , GPIOA, GPIO_PIN_15, GPIO_AF11_UART7},
    { UART7 , GPIOB, GPIO_PIN_4 , GPIO_AF11_UART7},
    { UART7 , GPIOE, GPIO_PIN_8 , GPIO_AF7_UART7 },
    { UART7 , GPIOF, GPIO_PIN_7 , GPIO_AF7_UART7 },
//UART8
...
//USART6
    { USART6, GPIOC, GPIO_PIN_6 , GPIO_AF7_USART6},
    { USART6, GPIOG, GPIO_PIN_14, GPIO_AF7_USART6},
}; 
