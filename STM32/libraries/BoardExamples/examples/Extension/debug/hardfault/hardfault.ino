/*
  hardFaultl.ino: Capture and print hardware failure information demo
                 (捕捉并打印硬件失败信息)
  Capture interrupt HardFault_Handler/MemManage_Handler/BusFault_Handler/UsageFault_Handler

  application api:
     _Error_Handler(char* , uint32_t);
     assert_param(int condition);      // defined USE_FULL_ASSERT
  hook:
