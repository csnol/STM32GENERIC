...
const stm32_tim_pin_list_type chip_tim1 [] = {
    ...
    { TIM1  ,GPIOE, GPIO_PIN_15 ,TIM_BKIN   , GPIO_AF1_TIM1  }, 
    ...
    { TIM1  ,GPIOE, GPIO_PIN_11 ,TIM_CH2    , GPIO_AF1_TIM1  }, 
    ...
    { TIM1  ,GPIOE, GPIO_PIN_13 ,TIM_CH3    , GPIO_AF1_TIM1  }, 
    { TIM1  ,GPIOB, GPIO_PIN_1  ,TIM_CH3N   , GPIO_AF1_TIM1  }, 
    { TIM1  ,GPIOB, GPIO_PIN_15 ,TIM_CH3N   , GPIO_AF1_TIM1  }, 
    { TIM1  ,GPIOE, GPIO_PIN_12 ,TIM_CH3N   , GPIO_AF1_TIM1  }, 
...
const stm32_tim_pin_list_type chip_tim5 [] = {
    ...
    { TIM5  ,GPIOH, GPIO_PIN_12 ,TIM_CH3    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOA, GPIO_PIN_3  ,TIM_CH4    , GPIO_AF2_TIM5  }, 
    { TIM5  ,GPIOI, GPIO_PIN_0  ,TIM_CH4    , GPIO_AF2_TIM5  }, 
}; 
