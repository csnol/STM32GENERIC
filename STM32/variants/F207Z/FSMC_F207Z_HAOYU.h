//F207Z_HAOYUElectroincs

#ifndef __FSMCF207ZHAOYU_H__
#define __FSMCF207ZHAOYU_H__
...
//sram  EM7644 psram
#define FSMC_MEMORY_TYPE	        FSMC_MEMORY_TYPE_PSRAM
#define FSMC_SRAMBANK               FSMC_NORSRAM_BANK2
#define SRAM_LENGTH	                ((uint32_t)(8*1024*1024))  /* 8M byte length */
