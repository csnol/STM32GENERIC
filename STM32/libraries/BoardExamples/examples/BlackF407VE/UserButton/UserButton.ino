...
void loop()
{
  ...
  // KEY_BUTTON is active high
  if  ( digitalRead( KEY_BUTTON ) != 0 ) digitalWrite(LED, HIGH); // led off

  // KEY_BUTTON and KEY_BUTTON1 are active low
  if  ( digitalRead( KEY_BUTTON2 ) == 0 ) digitalWrite(LED1, HIGH); // led off
  if  ( digitalRead( KEY_BUTTON1 ) == 0 )
  {
